...
The Microsoft Foundry service provides a REST API that you can use to submit prompts for content generation, including images generated by gpt-image-1.5 model.
...
2. In the configuration file, enter the following values for your Microsoft Foundry:
...
1. Enter the following command to add the `Azure.AI.OpenAI` NuGet package to your project, which is necessary for integrating with Microsoft Foundry model.
